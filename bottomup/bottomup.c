...
int main(int argc, char *argv[])
{
    ...
    // ! this was the solution. A negative biHeight means an image is upside down whereas a positive biHeight means it is bottomside down. I changed the height to a positive.
    if (bi.biHeight < 0)
    {
        bi.biHeight *= -1;
