/* 
    ! A program that runs a runoff election.  Each voter, in addition to specifying their first preference candidate, has also indicated their second and third choices.
*/
#include <cs50.h>
#include <ctype.h>
#include <stdio.h>
...
bool print_winner(void)
{
    ...
    // winner's votes must be greater than threshold.
